...
const ExperienceCard = ({ title, duration, type, description, index, isLast }) => {
  ...
  return (
    ...
    >
      {/* Duration column */}
      <div style={{ minWidth: "110px", textAlign: "right", paddingTop: "3px" }}>
        <span style={{
          fontSize: "0.72rem",
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
        <div style={{
          ...
          background: "#111", marginTop: "6px", flexShrink: 0,
        }} />
        {!isLast && (
